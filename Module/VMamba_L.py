...
if __name__ == '__main__':
    ...
    input_size = (512, 512)
    pretrained = False
    model = mamba_vision_L2_512_21k(pretrained=pretrained)
    model.eval()  # Set to evaluation mode

    # Create a dummy input tensor: batch_size=1, channels=3, height, width
    x = torch.randn(1, 3, input_size[0], input_size[1])

    # Get the multi-scale features
    features = model(x)

    # Print the shape of each layer's feature map
    print("Multi-scale features shapes:")
